...
export const DEFAULT_TEST_TOKENS: Record<string, string> = {
  ...
  '--ld-color-chart-1': '#ff0000',
  '--ld-color-chart-1-fill': 'rgba(255, 0, 0, 0.85)',
  '--ld-color-chart-2': '#f59e0b',
  '--ld-color-chart-3': '#2a9d8f',
  '--ld-color-chart-4': '#6366f1',
  '--ld-color-chart-5': '#94a3b8',
